...
namespace SuperUniqueNpc
{
	enum SuperUniqueNpc
    {
		...
		BaalSubject4 = 798,
		BaalSubject5 = 799,
		BloodRaven = 800 // D2BS doesnt have this?
	};
};

namespace SuperUnique
{
	enum SuperUnique
    {
		None = -1,
...
static bool isUseless(NPCCode::NPCCode code)
{
	switch (code)
	{
		...
		case NPCCode::CompellingOrb:	// at mephisto's temple in travincal
...
static bool isTownFolk(NPCCode::NPCCode code)
{
	switch (code)
	{
		// Act 1
		...
		case NPCCode::Gheed:
		case NPCCode::Warriv:
		case NPCCode::DeckardCain5:
		case NPCCode::Kashya:
		case NPCCode::Akara:
		// Act 2
		case NPCCode::Greiz:
		case NPCCode::Elzix:
		case NPCCode::Drognan:
		case NPCCode::Kaelan:
		case NPCCode::Jerhyn:
		case NPCCode::Warriv2:
		case NPCCode::Lysander:
		case NPCCode::Fara:
		case NPCCode::DeckardCain2:
		case NPCCode::Atma:
		case NPCCode::Geglash:
		case NPCCode::Meshif:
		// Act 3
		case NPCCode::Alkor:
		case NPCCode::Asheara:
		case NPCCode::Ormus:
		case NPCCode::DeckardCain3:
		case NPCCode::Meshif2:
		case NPCCode::Hratli:
		// Act 4
		case NPCCode::Tyrael2:
		case NPCCode::DeckardCain4:
		case NPCCode::Halbu:
		case NPCCode::Jamella:
		case NPCCode::Malachai: // Hadriel at the flame river? (considered town folk)
		// Act 5
		case NPCCode::Malah:
		case NPCCode::QualKehk:
		case NPCCode::Larzuk:
		case NPCCode::DeckardCain6:
		case NPCCode::Drehya: // Anya?? wtf?? might in frozen??
		case NPCCode::Drehya2: // Anya?? wtf??
		{
			return true;
		}
		default:
...
static bool isMonster(NPCCode::NPCCode code)
{
	if (isTownFolk(code) || isUseless(code))
	{
		return false;
	}
	else
...
static bool isResurrecter(NPCCode::NPCCode code)
{
	switch(code)
	{
	case NPCCode::FallenShaman:
	case NPCCode::CarverShaman:
	case NPCCode::DevilkinShaman:
	case NPCCode::DarkShaman:
	case NPCCode::WarpedShaman:
	case NPCCode::HollowOne:
	case NPCCode::Guardian:
	case NPCCode::Unraveler:
	case NPCCode::HoradrimAncient:
	case NPCCode::BaalSubjectMummy:
	case NPCCode::FetishShaman:
	case NPCCode::FlayerShaman:
	case NPCCode::SoulKillerShaman:
	case NPCCode::FleshSpawner:
	case NPCCode::StygianHag:
	case NPCCode::Grotesque:
		return true;
	}
	return false;
}
